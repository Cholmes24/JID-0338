...
def undo_penalty(num_penalties_to_remove, matchID, scoringID, receivingID, scoreValue, db):
...
def undo_warning(num_warnings_to_remove, matchID, scoringID, receivingID, scoreValue, db):
