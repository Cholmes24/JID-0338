...
export default function MatchScreen({ route }: ScreenPropType<'Match'>) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.scoreMonitor}>
        <View style={styles.FighterColumn}>
          <FighterColumn matchID={matchID} fighter={'fighter1'} />
        </View>
        <View style={styles.FighterColumn}>
          <FighterColumn matchID={matchID} fighter={'fighter2'} />
        </View>
      </View>
